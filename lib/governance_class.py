...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to aitherd "gobject list" output
    ...
    def aitherd_serialise(self):
        import aitherlib
        return aitherlib.SHIM_serialise_for_aitherd(self.serialise())
